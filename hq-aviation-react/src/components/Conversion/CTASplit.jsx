    ...
    <>
      <section style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
        ...
        <div style={{
          ...
          }}>Book a Trial Flight</h3>
          <p style={{
            opacity: 0.9,
            marginBottom: '1.5rem',
            maxWidth: '300px'
          }}>Experience helicopter flight firsthand. 30 minutes of pure magic.</p>
          <span style={{
        ...
        <div style={{
          ...
          <i className="fas fa-helicopter" style={{
            fontSize: '2.5rem',
            marginBottom: '1.5rem',
            opacity: 0.9
          }}></i>
          <h3 style={{
            ...
            textTransform: 'uppercase',
            marginBottom: '0.75rem'
          }}>View Our Aircraft</h3>
          <p style={{
            opacity: 0.7,
            marginBottom: '1.5rem',
            maxWidth: '300px'
          }}>Explore our range of new and pre-owned Robinson helicopters.</p>
          <span style={{
            fontFamily: 'var(--font-mono)',
            fontSize: '1rem',
            opacity: 0.5,
            marginBottom: '1.5rem'
          }}>R22 • R44 • R66 • R88</span>
